...
# # 0010 SRT Pilot
# 
# This is the data analysis of experiment 0010 SRT pilot. This analysis includes every step from the original raw-data files to the final results output for this experiment (including figures). Katie runs the majority of her data analysis in the ipython notebook, with some additional analysis run in SPSS.
# 
...
def add_group_block_num(df):
    ...
    for gblock in arange(1, 5):
        gblocks.extend(repeat(gblock, 400))
    df['gblocks'] = gblocks
    return df
...
trial_data.to_csv("/Users/kathrynschuler/Documents/current/research/raw-data-processed/0010-SRT-pilot-processed.csv", sep = ",")
